        ...
        <header className="flex justify-between gap-30 items-center py-4 px-4 md:px-10 lg:px-20 bg-[linear-gradient(90deg,#082250_0%,#0B2760_15%,#001C4A_45%,#052044_65%,#234F72_100%)]">
            ...
            <div className={`flex flex-col px-6 gap-16 w-3/4 z-10 bg-black/50 backdrop-blur-sm lg:hidden py-16  ${
                ...
                <div className="flex flex-col gap-5">
                    <button className="text-sm px-5.5 py-3.5 rounded-md bg-white text-blue600 text-center">Deploy EventsIntel for Your Event</button>
                    <Link to='/demo-form' className="text-sm px-8.5 py-3.5 rounded-md bg-pink text-white text-center">Request a Demo</Link>
                </div>
            </div>
        </header>
        <main>{children}</main>
