...
const actions = [
  {
    title: "Follow-up with GreenPower Ltd.",
    date: "June 9th, 2026 (Tomorrow)",
    status: "OVERDUE",
  },
  {
    title: "Share deck with Plug and Play Ventures",
    date: "June 8th, 2026 (2 days left)",
    status: "HIGH",
  },
  {
    title: "Follow-up with GreenPower Ltd.",
    date: "June 7th, 2026 (3 days left)",
    status: "MEDIUM",
  },
];
...
const actionData = [
  {
    title: "Follow-up meeting with Africa Finance",
    description: "AI & Innovation Hub",
    action: "Commitment",
    related: "Africa Finance Corporation",
    sector: "Infrastructure",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
  },
  {
    title: "Share investor deck with Plug and Play",
    description: "Ventures for Lagos Innovation Hub.",
    action: "Follow-up",
    related: "Plug and Play Ventures",
    sector: "Technology",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
  ...
  {
    title: "Policy review meeting with Ministry of",
    description: "Transport on PPP framework.",
    action: "Policy",
    related: "Ministry of Transport",
    sector: "Transport",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
  ...
  {
    title: "Investor roundtable follow-up schedule",
    description: "one-on-one with interested investors.",
    action: "Follow-up",
    related: "Investors Roundtable",
    sector: "Multi-Sector",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
  ...
  {
    title: "Explore partnership on renewable energy",
    description: "project in Lagos.",
    action: "Commitment",
    related: "GreenPower Ltd.",
    sector: "Energy",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
  ...
  {
    title: "Provide cost-benefit analysis for proposed",
    description: "Lekki Deep Sea Port expansion.",
    action: "Action Item",
    related: "InfraCorp Ltd.",
    sector: "Infrastructure",
    owner: "Babajide Sanwo-Olu",
    position: "Governor, Lagos State",
    img: "/Babajide-Sanwo-olu 2.png",
    ...
    <section className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-white font-lexend font-light text-xs">
          Track commitment, follow-ups and outcomes beyound discussion
        </p>
      </div>
      ...
      <menu className="flex items-center gap-3 overflow-x-auto">
        ...
        <button className="px-10 py-1 text-slate100 text-sm font-lexend font-medium">
          MY ACTIONS
        </button>
        <button className="px-10 py-1 text-slate100 text-sm font-lexend font-medium">
          OVERDUE
      ...
      <div className="flex items-center gap-5 flex-wrap">
        <div className="border border-white/55 rounded py-2.5 px-2.5 flex items-center gap-1.5 min-w-80">
          ...
          <input
            ...
            className="flex-1 text-white text-sm font-lexend outline-none placeholder:text-white"
          />
        </div>
            ...
            {actionData.map(
              (
                ...
                >
                              ...
                              : i === 3
                                ...
                                : i === 4
                                  ...
                                  : i === 5
                                    ? "bg-blue200"
                                    : ""
                      } w-12 h-12 rounded-md shrink-0`}
                    ></div>
                    <div className="flex flex-col gap-1.5">
                      <h6 className="text-white font-lexend font-light text-sm">
                        {title}
                      </h6>
                      <span className="text-white font-lexend font-light text-sm">
                        {description}
                      </span>
                      <div
                        className={`text-xs text-white font-lexend rounded-md py-1 px-3.5 self-start ${
                          action === "Commitment"
                            ? "bg-green500"
                            : action === "Follow-up"
                              ? "bg-purple200"
                  ...
                  <p className="text-white font-lexend font-light text-sm text-center">
                    {related}
                  </p>
                  <p className="text-white font-lexend font-light text-sm ">
                    {sector}
                  </p>
                  <div className="flex items-center gap-2">
                    <img
                      src={img}
                      alt=""
                      className="w-12.5 h-12.5 rounded-full shrink-0"
                    />
                    <div className="flex flex-col gap-1">
                      <span className="text-white font-dmSans font-semibold text-sm">
                        {owner}
                      </span>
                      <span className="text-white font-dmSans font-medium text-xs">
                        {position}
                      </span>
                    </div>
                  </div>
            ...
            <div key={i} className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <span
                    className={`${status.toLowerCase() === "overdue" ? "text-red100" : "text-slate100"} font-lexend font-light text-xs`}
                  >
                    {date}
                  </span>
                </div>
              ...
              <div
                className={`py-1.25 px-3.75 rounded-md border uppercase font-dmSans text-xs ${status.toLowerCase() === "overdue" ? "border-red100 bg-transparent text-red100" : "text-yellow200 border-yellow200 bg-yellow100"}`}
              >
                {status}
              </div>
            </div>
